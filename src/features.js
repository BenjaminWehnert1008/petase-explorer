...
export const FEATURES = [
  ...
  { key: "placer_score", label: "PLACER preorganization", group: "Catalysis features", higher: "better", fmt: num(3), desc: "Active-site preorganization score from PLACER conformational sampling (equal-weights composite of RMSD, ΔRMSF, and ligand RMSF z-scores)." },
  { key: "hbond_freq", label: "H-bond frequency (PLACER)", group: "Catalysis features", higher: "better", fmt: num(3), desc: "Fraction of PLACER conformational snapshots in which a catalytic hydrogen bond is formed." },
  { key: "rmsd_apo_vs_aei_z", label: "RMSD apo vs. AEI (z)", group: "Catalysis features", higher: "lower", fmt: num(3), desc: "Z-scored backbone RMSD between the apo and active-enzyme-intermediate (AEI) conformations — how much the backbone must reorganize to reach the catalytic state." },
  { key: "delta_rmsf_aei_apo_z", label: "ΔRMSF AEI−apo (z)", group: "Catalysis features", higher: "context", fmt: num(3), desc: "Z-scored difference in residue RMSF between the AEI and apo ensembles — positive means more flexible in the AEI." },
  { key: "aei_stdev_rmsd_z", label: "AEI stdev RMSD (z)", group: "Catalysis features", higher: "lower", fmt: num(3), desc: "Z-scored standard deviation of the ligand RMSD within the AEI ensemble — lower means a more pre-organized binding pocket." },
